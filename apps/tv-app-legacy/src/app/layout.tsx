...
` }} />
        {/* Boot splash — uses the official neofilm-wordmark.png so it matches
            the in-app TopBar and the LoadingSpinner exactly. Injected via
            <head> script so it lives OUTSIDE the React hydration tree. The
