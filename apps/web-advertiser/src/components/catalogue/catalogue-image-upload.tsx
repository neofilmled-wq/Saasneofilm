...
export function CatalogueImageUpload({ value, onChange }: CatalogueImageUploadProps) {
  ...
  if (value) {
    return (
      <div className="relative aspect-[2/1] w-full overflow-hidden rounded-lg border bg-muted">
      ...
      >
        {uploading ? (
          ...
          <div className="flex flex-col items-center gap-2 text-center">
            ...
            <p className="text-xs text-muted-foreground">JPEG, PNG, WebP — max {MAX_SIZE_MB}MB</p>
